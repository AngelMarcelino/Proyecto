        ...
        <form action="Users/editUser.php" method="post" enctype="multipart/form-data">
			<div class="row top-row">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" name="Nombre" required value="<?php echo $usuario['Nombre'] ?>" class="form-control" />
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="email" name="Correo" required value="<?php echo $usuario['Correo'] ?>"  class="form-control" />
			...
			<div class="row top-row">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" name="NombreUsuario" required value="<?php echo $usuario['NombreUsuario'] ?>"  class="form-control" />
			...
			<div class="row top-row">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="password" name="ConfContra" required  class="form-control" />
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" name="Colonia" required value="<?php echo $usuario['Colonia'] ?>"  class="form-control" />
			...
			<div class="row top-row">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" name="Calle" required value="<?php echo $usuario['Calle'] ?>"  class="form-control" />
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" name="Numero" required value="<?php echo $usuario['NInt'] ?>"  class="form-control" />
